...
let viaHandler = async function (event, functionName) {
...
exports.we_invoke_get_index = async function() {
  let res = 
    mode === 'handler'
...
exports.we_invoke_get_restaurants = async function() {
  let res = 
    mode === 'handler'
...
exports.we_invoke_search_restaurants = async function(user, theme) {
